...
export const examPapers = [
    {
        ...
        questions: [
            ...
            },
            {
                ...
                answer: '1. 诚实（Honest）：领导者应该信守承诺，言行一致，让团队成员感到信任和尊重。\n2. 能力（Competent）：领导者必须展现出卓越的能力和广泛的知识。\n3. 远见（Visionary）：知识工作者倾向于寻求发展和创新。领导者需要能够超越眼前的挑战和任务，具备明确和可信的未来愿景。这种远见不仅包括对技术和行业趋势的理解，还包括对组织发展方向的清晰认识。\n4. 激励（Inspirational）：优秀的知识工作者领导者应该能够激励团队，传播积极、充满热情和能量的未来愿景。',
                explanation: '本题考查知识工作领导者的品质。正确答案在PPT团队动力学当中。四个品质特点是固定的：诚实(Honest)、能力(Competent)、远见(Visionary)、激励(Inspirational)。',
                score: 9,
                year: 2023,
                topic: '团队管理'
            },
    ...
    },
    {
        ...
        questions: [
            ...
            },
            {
                ...
                correctAnswer: '',
                explanation: '本题四个选项均不正确（可能是回忆版题目信息不完整）：\n\nA ❌ EVM不能直接用于软件质量管理——EVM的局限性之一就是「一般不能应用于软件项目的质量管理」，EVM仅关注进度和成本绩效。\n\nB ❌ EVM中级实现只引入了**日程偏差**(SV=EV-PV, SPI=EV/PV)，并没有成本信息；成本差异(CV)和成本指数(CPI)是在**高级实现**中才引入的。\n\nC ❌ EVM完全依赖准确的估算作为基础，「项目早期很难准确估算」正是EVM的主要局限之一。\n\nD ❌ SPI>1表示进度**超前**(效率高于计划)，而非落后；CPI>1表示成本**节约**(花得更少)，而非超支。\n\nEVM三级实现：\n- 简单：仅PV/EV(进度)\n- 中级：+SV/SPI(日程偏差)\n- 高级：+CV/CPI/EAC(成本+预测)',
                year: 2025,
                topic: '项目管理'
            },
            {
