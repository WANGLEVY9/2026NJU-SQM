    ...
    },
    {
        ...
        questions: [
            ...
            },
            {
                ...
                correctAnswer: 'C',
                explanation: 'C ✅ 正确——EVM完全依赖准确估算作为基础，「项目早期很难准确估算」是EVM的主要局限之一。PV（计划价值）需要基于WBS的准确工作量估算，EV需要明确的完成度判定规则，AC依赖成本跟踪精度。\n\nA ❌ EVM不能用于质量管理——EVM仅关注进度和成本绩效。\n\nB ❌ 中级实现只引入**日程偏差**(SV=EV-PV, SPI=EV/PV)；CV/CPI等成本指标在**高级实现**中才引入。\n\nD ❌ SPI>1表示进度**超前**，CPI>1表示成本**节约**。\n\nEVM三级：简单(PV/EV)→中级(+SV/SPI)→高级(+CV/CPI/EAC)',
                year: 2025,
                topic: '项目管理'
            },
            {
